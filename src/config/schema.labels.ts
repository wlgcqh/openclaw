...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "dynamicAgents.enabled": "Dynamic Agents Enabled",
  "dynamicAgents.template": "Dynamic Agent Template",
  "dynamicAgents.template.inheritDefaults": "Inherit Agent Defaults",
  ...
  "dynamicAgents.template.model": "Dynamic Agent Model",
  "dynamicAgents.template.thinkingDefault": "Dynamic Agent Thinking Default",
  "dynamicAgents.template.tools": "Dynamic Agent Tools",
  "dynamicAgents.template.sandbox": "Dynamic Agent Sandbox",
  "dynamicAgents.storage": "Dynamic Agents Storage",
  "dynamicAgents.storage.path": "Storage Path",
  "dynamicAgents.api": "Dynamic Agents API",
  "dynamicAgents.api.authToken": "API Auth Token",
  broadcast: "Broadcast",
